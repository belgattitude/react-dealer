...
class DealerList extends React.Component {
    ...
    render() {
        ...
        return (
            <div >
                <ul className="dealer_locator_list">
                    {
                            ...
                            return (
                                <li key={ dealer.contact_id } onClick={boundClick}>
                                    ...
                                    <div className="dealer_distance">
                                        Distance: <span>{ Math.round(dealer.distance_from_place * 10) / 10 } miles</span>
                                    </div>

                                    <p className="dealer_address" translate="no" typeof="schema:PostalAddress">
                                        <span className="dealer_name" property="schema:name">{dealer.contact_name}</span>
                                        <br />
                                        { dealer.is_country_distributor == 1 ?
                                            <p>
                                                <button type="button" className="btn btn-primary btn-xs">Official distributor in { dealer.country_name } </button>
                                            </p>
                                            :
                                            ''
                                        }
                                        ...
                                        <abbr className="dealer_state" title={ dealer.state_name } property="schema:addressRegion">{dealer.state_reference}</abbr>
                                        <span className="dealer_zipcode" property="schema:postalCode">{dealer.zipcode}</span>&nbsp;
                                        <span className="dealer_city" property="schema:addressLocality">{dealer.city}</span><br />
                                        <abbr className="dealer_country" property="schema:addressCountry">{dealer.country_name}</abbr>
                                    </p>


                                    <div className="dealer_contact">
                                        <div className="dealer_homepage">
                                            Homepage: <span><a target="_blank" href={ "http://" + dealer.homepage }> {dealer.homepage}</a></span>
                                        </div>
